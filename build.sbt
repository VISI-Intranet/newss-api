...
assemblyMergeStrategy in assembly := {
  ...
  case PathList("google", "protobuf", "any.proto") => MergeStrategy.discard
  case PathList("google", "protobuf", "descriptor.proto") => MergeStrategy.discard
  case PathList("google", "protobuf", "empty.proto") => MergeStrategy.discard
  case PathList("google", "protobuf", "struct.proto") => MergeStrategy.discard
